package com.pomolex.enduromotorcycleguide.persistence.entity;
...
public enum ErrorTemplates {
  ...
  PASSWORD(
      "Поле %s має мати тільки латинські символи, хочаб одна буква з великої, одна з малої та хочаб одна цифра.");
